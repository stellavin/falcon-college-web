...
const President = ({ title, Lectures }) => {
  ...
  const getAllLectures = () => {
    ...
    axios
      .get(`http://localhost:8080/api/allLecture`, {
        headers: {
  ...
  const getCredit = () => {
    axios.get(`http://localhost:8080/api/getTotalCredits`).then((res) => {
      console.log(res);
    });
  };
        ...
        <div className="flex items-center w-full md:w-1/2 space-x-4">
          ...
          <div className="w-1/2">
            <div className="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
              ...
              <p className="text-gray-400 text-sm">Total Eng Credit</p>
            </div>
          </div>
          ...
          <div className="w-1/2">
            <div className="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
              ...
              <p className="text-gray-400 text-sm">Total Science Credit</p>
            </div>
          </div>
        </div>
      </div>
